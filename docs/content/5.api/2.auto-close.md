...
- `options` (optional) - `frontmatter: true` completes an unclosed leading frontmatter block; `syntax: false` skips Comark component-fence closing (for content parsed without the syntax plugin)
