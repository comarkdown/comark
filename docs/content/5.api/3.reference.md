...
const tree1 = await parser('# Document 1\n\nContent...')
const tree2 = await parser('# Document 2\n\nMore content...')
const tree3 = await parser('# Document 3\n\nEven more...')
```
...
```typescript
// Core parsing
import { parse, createParser, autoCloseMarkdown } from 'comark'
