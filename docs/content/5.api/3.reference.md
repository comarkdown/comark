...
interface HighlightOptions {
  themes?: Record<string, BundledTheme>    // Theme configuration - import from @shikijs/themes
  languages?: BundledLanguage[]             // Languages to include - import from @shikijs/langs
