...
Some plugins export pre-built conditional handlers. For example, the [footnotes plugin](/plugins/core/footnotes#stringify-markdown-rendering) provides `Footnote`:
