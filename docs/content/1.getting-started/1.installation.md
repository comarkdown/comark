...
| **Provides** | `<Markdown>`, `<MarkdownParsed>` (internal parsing and rendering components) | `renderANSI()`, `renderHTML()` (not framework related) | `parse()`, `renderMarkdown()` (programmatic parsing and rendering) |
