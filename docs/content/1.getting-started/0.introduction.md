---
title: Introduction
description: Comark is a powerful Markdown parser that extends standard Markdown with component syntax, enabling rich, interactive content in Vue, React, Svelte, and Angular applications.
links:
  - label: Installation
