...
::callout{to="/getting-started/installation#browser-extension" icon="i-lucide-puzzle"}
Install the [Comark for GitHub browser extension](/getting-started/installation#browser-extension) to visualize Comark components and attributes syntax directly on GitHub Markdown pages.
::
