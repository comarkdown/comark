...
::callout
Comark also support JSON-render syntax in code-blocks to render components, checkout the [json-render plugin](http://localhost:3000/plugins/built-in/json-render).
::
