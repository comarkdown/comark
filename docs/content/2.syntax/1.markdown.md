---
title: Comark Syntax
description: Comark is a superset of CommonMark and GitHub Flavored Markdown (GFM) with additional features for creating components and attributes.
navigation:
  title: Comark
---
...
This means your components receive fully typed props — objects remain objects, arrays remain arrays, and numbers/booleans are parsed as their respective types rather than strings.
...
- [Summary Plugin](/plugins/core/summary) - Extract content summaries with `<!-- more -->`
