...
Comark treats partial input as a primary use case. [Auto-close](/reference/auto-close) completes unterminated syntax, including half-open `::component` blocks, so AI-generated content renders correctly token by token:
