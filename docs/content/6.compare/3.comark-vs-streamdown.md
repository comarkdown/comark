...
::accordion
  ...
  Yes. [Shiki highlighting](/plugins/built-in/shiki), [KaTeX math](/plugins/built-in/math), and [Mermaid](/plugins/built-in/mermaid) are one-line opt-ins, keeping the core small when you don't need them.
  :::
::
