...
- `tree` - The [`MarkdownDocument`](/syntax/markdown-ast#markdowndocument) to traverse
- `checker` - A predicate `(node: Node) => boolean`, return `true` to visit a node
- `visitor` - A transform `(node: Node) => Node | false | void`, see [`Node`](/syntax/markdown-ast#comarknode)
