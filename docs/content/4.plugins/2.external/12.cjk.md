...
The CJK plugin provides optimized text handling for Chinese, Japanese, and Korean (CJK) languages. It handles line breaks correctly to prevent unwanted spaces between CJK characters.

The plugin is included in `comark` — no separate installation needed.
