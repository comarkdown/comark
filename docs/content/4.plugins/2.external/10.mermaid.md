...
The Mermaid plugin enables rendering of [Mermaid](https://mermaid.js.org/) diagrams in your markdown content. Mermaid lets you create diagrams and visualizations using text and code.

The plugin is included in `@comark/vue` and `@comark/react`. You only need to install the `beautiful-mermaid` peer dependency:
