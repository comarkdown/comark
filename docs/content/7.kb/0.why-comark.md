...
**That shift makes Markdown data, not code.** Because `parse(markdown)` is a pure function returning a [Markdown AST](/syntax/markdown-ast), the full CMS pattern becomes possible:
