---
title: Nuxt
description: Learn how to use Comark Syntax in a Nuxt application.
navigation:
  title: Nuxt
...
When `@nuxt/ui` is installed, Comark Syntax automatically uses Nuxt UI's prose components for enhanced styling.
...
The `comark/nuxt` module detects Nuxt UI and:
...
<template>
  <Comark v-if="content" :markdown="content" />
</template>
```
...
- [Comark Syntax](/syntax/markdown) - Markdown component syntax
