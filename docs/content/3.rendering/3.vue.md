...
::tip{to="/rendering/vue#comarkrenderer"}
...
See the Component Syntax docs for the full component API — props, named slots, nested components, and more.
::
...
| `autoUnwrap` | `boolean` | `false` | Automatically unwrap single block elements |
...
Parse your markdown content on the server:
...
Pass the parsed tree to the `tree` prop:
...
::steps{level="3"}
### Create a component to override any HTML element
...
- [Auto-Close API](/api/auto-close) - Auto-close internals and manual stream parsing
