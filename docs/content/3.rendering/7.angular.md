...
The `<comark-markdown>` component is the simplest way to render markdown in Angular. It handles parsing and rendering automatically. The `value` input accepts a markdown **string** or a pre-parsed [`MarkdownTree`](/syntax/comark-ast).
