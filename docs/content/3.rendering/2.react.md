---
title: React
description: Learn how to use Comark in a React application.
---

Render Comark content in React applications with the `Comark` component.
...
export default function Content({ content }: Props) {
  return <Comark markdown={content} className="prose" />
}
