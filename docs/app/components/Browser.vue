...
<template>
  <div class="border border-muted rounded-lg overflow-hidden my-6 not-prose">
    <div class="flex items-center gap-2 px-4 py-2.5 bg-elevated border-b border-muted">
      ...
      <div class="flex-1 flex items-center gap-1.5 bg-default rounded-md px-3 py-1.5 text-sm text-muted font-mono truncate border border-muted">
        <UIcon
          name="i-lucide-lock"
