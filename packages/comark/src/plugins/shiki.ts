 ...
 */
export async function getHighlighter(options: ShikiOptions = {}): Promise<ShikiPrimitive> {
  if (highlighter) {
...
async function registerDefaults(options: ShikiOptions) {
...
export default defineComarkPlugin<ShikiOptions>((options: ShikiOptions = {}) => ({
  name: 'shiki',
  async post(state) {
