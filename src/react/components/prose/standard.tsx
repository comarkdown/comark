...
const ProseH1Standard: React.FC<React.HTMLAttributes<HTMLHeadingElement> & { __node?: any }> = ({ __node, ...props }) => (
  <h1 className="prose-h1-standard text-5xl font-bold mt-0 mb-8 text-gray-900 dark:text-white leading-tight" {...props} />
)

const ProseH2Standard: React.FC<React.HTMLAttributes<HTMLHeadingElement> & { __node?: any }> = ({ __node, ...props }) => (
  <h2 className="prose-h2-standard text-4xl font-bold mt-16 mb-6 text-gray-800 dark:text-gray-100" {...props} />
)

const ProseH3Standard: React.FC<React.HTMLAttributes<HTMLHeadingElement> & { __node?: any }> = ({ __node, ...props }) => (
  <h3 className="prose-h3-standard text-3xl font-semibold mt-12 mb-4 text-gray-800 dark:text-gray-100" {...props} />
)

const ProseH4Standard: React.FC<React.HTMLAttributes<HTMLHeadingElement> & { __node?: any }> = ({ __node, ...props }) => (
  <h4 className="prose-h4-standard text-2xl font-semibold mt-10 mb-3 text-gray-700 dark:text-gray-200" {...props} />
)

const ProseH5Standard: React.FC<React.HTMLAttributes<HTMLHeadingElement> & { __node?: any }> = ({ __node, ...props }) => (
  <h5 className="prose-h5-standard text-xl font-semibold mt-8 mb-3 text-gray-700 dark:text-gray-200" {...props} />
)

const ProseH6Standard: React.FC<React.HTMLAttributes<HTMLHeadingElement> & { __node?: any }> = ({ __node, ...props }) => (
  <h6 className="prose-h6-standard text-lg font-semibold mt-6 mb-2 text-gray-600 dark:text-gray-300" {...props} />
)

// Text elements
const ProsePStandard: React.FC<React.HTMLAttributes<HTMLParagraphElement> & { __node?: any }> = ({ __node, ...props }) => (
  <p className="prose-p-standard my-6 text-gray-700 dark:text-gray-300 leading-relaxed text-lg" {...props} />
)

const ProseStrongStandard: React.FC<React.HTMLAttributes<HTMLElement> & { __node?: any }> = ({ __node, ...props }) => (
  <strong className="prose-strong-standard font-bold text-gray-900 dark:text-gray-100" {...props} />
)

const ProseEmStandard: React.FC<React.HTMLAttributes<HTMLElement> & { __node?: any }> = ({ __node, ...props }) => (
  <em className="prose-em-standard italic text-gray-600 dark:text-gray-400" {...props} />
)

const ProseDelStandard: React.FC<React.HTMLAttributes<HTMLElement> & { __node?: any }> = ({ __node, ...props }) => (
  <del className="prose-del-standard line-through text-gray-500 dark:text-gray-500 opacity-75" {...props} />
)
...
const ProseCodeStandard: React.FC<React.HTMLAttributes<HTMLElement> & { __node?: any }> = ({ __node, ...props }) => (
  <code className="prose-code-standard bg-gray-100 dark:bg-gray-800 text-pink-600 dark:text-pink-400 px-2 py-1 rounded text-base font-mono" {...props} />
)

const ProsePreStandard: React.FC<React.HTMLAttributes<HTMLPreElement> & { __node?: any }> = ({ __node, ...props }) => (
  <pre className="prose-pre-standard bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 p-6 rounded-xl overflow-x-auto my-8 border border-gray-200 dark:border-gray-800 text-base leading-relaxed" {...props} />
)

// Lists
const ProseUlStandard: React.FC<React.HTMLAttributes<HTMLUListElement> & { __node?: any }> = ({ __node, ...props }) => (
  <ul className="prose-ul-standard list-disc list-outside ml-6 my-6 text-gray-700 dark:text-gray-300 space-y-3 text-lg" {...props} />
)

const ProseOlStandard: React.FC<React.OlHTMLAttributes<HTMLOListElement> & { __node?: any }> = ({ __node, ...props }) => (
  <ol className="prose-ol-standard list-decimal list-outside ml-6 my-6 text-gray-700 dark:text-gray-300 space-y-3 text-lg" {...props} />
)
...
const ProseBlockquoteStandard: React.FC<React.BlockquoteHTMLAttributes<HTMLQuoteElement> & { __node?: any }> = ({ __node, ...props }) => (
  <blockquote className="prose-blockquote-standard border-l-4 border-blue-400 dark:border-blue-600 pl-6 my-8 text-gray-600 dark:text-gray-400 italic text-xl" {...props} />
)
...
const ProseTrStandard: React.FC<React.HTMLAttributes<HTMLTableRowElement> & { __node?: any }> = ({ __node, ...props }) => (
  <tr className="prose-tr-standard border-b border-gray-200 dark:border-gray-800" {...props} />
)

const ProseThStandard: React.FC<React.ThHTMLAttributes<HTMLTableCellElement> & { __node?: any }> = ({ __node, ...props }) => (
  <th className="prose-th-standard bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-6 py-3 text-left font-semibold text-gray-900 dark:text-white" {...props} />
)

const ProseTdStandard: React.FC<React.TdHTMLAttributes<HTMLTableCellElement> & { __node?: any }> = ({ __node, ...props }) => (
  <td className="prose-td-standard border border-gray-200 dark:border-gray-800 px-6 py-3 text-gray-700 dark:text-gray-300" {...props} />
)

// Other elements
const ProseHrStandard: React.FC<React.HTMLAttributes<HTMLHRElement> & { __node?: any }> = ({ __node, ...props }) => (
  <hr className="prose-hr-standard my-12 border-t border-gray-300 dark:border-gray-700" {...props} />
)
...
const ProseCardStandard: React.FC<CardProps> = ({ title, children, ...props }) => (
  <div className="prose-card-standard border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-xl p-6 my-8 shadow-md hover:shadow-lg transition-shadow" {...props}>
    {title && <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">{title}</h3>}
    <div>{children}</div>
  </div>
)
